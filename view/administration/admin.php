    ...
    <!-- <div class="right-contentProfile"> -->
        ...
        <div class="containerProfile">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <h3 style="text-align: center;">LISTE DES RESERVATIONS</h3> 
              <div class="booking">
              <table>   
                <tr>
                <th>Action</th>
                ...
                <?php foreach($newstats as $stat): ?>
                    ...
                    <td><?= date('d/m/Y', strtotime($stat->date_debut)) ?></td>
                    <td><?=date('d/m/Y', strtotime($stat->date_fin)) ?></td>
                    <td><?=$stat->type ?></td>
                    <td><?=$stat->email ?></td>
              ...
              <h3 style="text-align: center;">LES FEEDBACKS</h3> 
              <table>   
                <tr>
                <th>Action</th>
                <th>Nom du client</th>
              ...
              <h3 style="text-align: center;">LES REACTIONS</h3>
              <table>   
                <tr>
